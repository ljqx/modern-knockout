...
ko.observableArray.fn = {
    'remove': function (valueOrPredicate) {
        ...
        var removedValues = [];
        var predicate = _.isFunction(valueOrPredicate) && !ko.isObservable(valueOrPredicate) ? valueOrPredicate : function (value) { return value === valueOrPredicate; };
...
_.each(['slice'], function (methodName) {
    ko.observableArray.fn[methodName] = function () {
        var underlyingArray = this();
